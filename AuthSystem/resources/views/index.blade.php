...
<li><a href="{{url('login')}}"><button id="btnLogin">Login</button></a></li>
@endsection
...
@section('body')
  ...
  <div class="wrapper">
    <form method="post" action="{{route('sendData')}}" enctype="multipart/form-data" id="form" name="register">
      ...
      <br>
      <div class="input-box">
        <label for="Full_Name"><b>Full-Name <span class="red-asterisk"></span> </b></label>

        <input type="text" placeholder="Enter Full-Name" name="Full_Name" id="Full_Name" required />
      </div>
      <br>
      <div class="input-box">
        <label for="User_Name"><b>Username <span class="red-asterisk"></span></b></label>
        <input type="text" placeholder="Enter username" name="User_Name" id="User_Name" required />
      </div>
      <br>
      <div id="BDate">
        <label for="BDate"><b> Birthdate <span class="red-asterisk"></span> </b></label>
        <input type="date" value="BDate" id="dd" name="BDate" required />
        <input type="button" value="Send" id="BDS">
      </div>
      <br>
      <div class="input-box">
        <label for="phoneNum"><b> Phone <span class="red-asterisk"></span></b></label>
        <input type="tel" placeholder="xxxxxxxxxxx" name="phoneNum" id="phoneNum" pattern="01[0125][0-9]{8}" required />
      </div>
      <br>
      <div class="input-box">
        <label for="address"><b> Address <span class="red-asterisk"></span></b></label>
        <input type="text" placeholder="Enter Address" name="address" id="address" required />
      </div>
      <br>
      <div class="input-box">
        <label for="e-mail"><b>E-mail <span class="red-asterisk"></span> </b></label>
        <input type="email" placeholder="example@gmail.com" pattern="[a-z0-9._%+-]+@gmail.com$" name="e-mail" id="e-mail" required />
      </div>
      <br>
      <div class="input-box">
        <label for="pass"><b>Passowrd <span class="red-asterisk"></span></b></label>
        <input type="password" name="pass" id="pass" required pattern="^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{8,}$" />
        <p><small> <span class="red-asterisk"></span> At least 8 characters, 1 number literal and 1 special character</small></p>
      </div>
      <br>
      <div class="input-box">
        <label for="confpass"><b>Confirm Passowrd <span class="red-asterisk"></span> </b></label>
      ...
      <p id="captchaError"><small> <span class="red-asterisk"></span> Please prove that you're not a robot</small></p>
      <br>
      <br>
      <div class="btn-group">
